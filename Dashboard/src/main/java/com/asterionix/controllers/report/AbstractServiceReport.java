...
abstract class AbstractServiceReport {
	...
	protected CrudRepository<? extends IEntity, Long> crudRepository;
	
	
	protected List<PageTab> tabs;
	
	public AbstractServiceReport(CrudRepository<? extends IEntity, Long> repository){
